...
base_mAP50 = [60.9, 69.2, 89.0, 89.2, 94.6]  # 原网络的mAP50
wbsi_mAP50 = [72.8, 82.3, 89.6, 91.3, 95.0]  # 集成WBSI后的mAP50
...
# 调整布局并显示
plt.tight_layout()
plt.savefig("融合前后晚期AP对比.png", dpi=300, bbox_inches='tight')
plt.show()