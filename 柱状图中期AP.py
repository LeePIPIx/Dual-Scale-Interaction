...
base_mAP50 = [77.3, 83.1, 91.2, 94.8, 94.5]  # 原网络的mAP50
wbsi_mAP50 = [85.5, 90.7, 92.6, 96.0, 97.0]  # 集成WBSI后的mAP50
...
autolabel(rects1)
autolabel(rects2)
ax.set_xlim(left=70)  # 从60开始，隐藏60以下的刻度
ax.set_xticks([70, 80, 90, 100])  # 设置60以上的刻度

# 调整布局并显示
plt.tight_layout()
plt.savefig("融合前后中期AP对比.png", dpi=300, bbox_inches='tight')
plt.show()